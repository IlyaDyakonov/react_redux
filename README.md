# ТАК КАК ЭТА ЗАДАЧА ИМЕЕТ ОДИН ИЗХОДНЫЙ КОД, СДЕЛАНА ОНА В ОДНОМ ЕДИНОМ РЕШЕНИИ СРАЗУ СО ВСЕМ ФУНКЦИОНАЛОМ!
...
Взяв за основу проект, рассмотренный на лекции, или [проект редактирования](./src/components/TaskOne/), предложите вариант реализации возможности фильтрации: то есть у вас должно быть строковое поле, при введении данных в которое будут отображаться только объекты, у которых название содержит введённую строку.
